		...
		<div class="col-xs-10 col-xs-offset-1">
			<div id="header" class="row">
				...
				<div class="col-xs-3 no-padding-right">
					<a href="/penguji/mutu-panen/tambah "><img class="icon icon-right" src="{{ URL::asset('assets/img/plus.png') }}"></a>
				</div>
			</div>
				...
				<div class="col-xs-12 konten with-title">
					...
					<table>
						...
						<tbody>
							...
							<tr class="clickable-row" data-href="/penguji/mutu-panen/rincian/{{ $panen->id_panen }}">
								<td>{{ ++$no }}</td>
