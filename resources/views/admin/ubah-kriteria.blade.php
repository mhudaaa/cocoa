		...
		<div class="col-xs-10 col-xs-offset-1">
			<div id="header" class="row">
				...
				<div class="col-xs-8 text-center">
					<h6 class="title">Ubah Kriteria</h6>						
				</div>
			...
			<form method="post" action="/admin/kriteria/setUpdate/{{ $kriteria->id_kriteria }}" autocomplete="off">
				{{ csrf_field() }}
				<div class="row">
						...
						<table>
							<tbody>
								<tr class="left-all">
									...
									<td><input type="text" name="kriteria" value="{{ $kriteria->kriteria }}"></td>
								</tr>
								<tr class="left-all">
									<td class="text-brown bold">Nilai</td>
									<td><input type="number" step="0.01" name="nilai" value="{{ $kriteria->nilai }}" required=""></td>
								</tr>
							</tbody>
						</table>
					</div>
